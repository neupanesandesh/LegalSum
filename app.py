...
def main():
    ...
    if st.session_state["authentication_status"]:
        ...
        if app_mode == "Legal Decision Summarizer":
            ...
            if choice1 == 'Copy-Paste Text':
                ...
                if user_file_input is not None and st.button("Process Document"):
                    try:
                        ...
                        # Store processed text and first two pages in session state
                        if combined_text:
            ...
            # Additional inputs and summarization logic
            if user_input and st.button("Summarize"):
                state = st.selectbox("Select a US State:", ["New Jersey", "Texas", "Connecticut"])
                if state == "New Jersey":
